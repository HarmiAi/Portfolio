          ...
          {contacts.map((contact, index) => {
            ...
            return (
              <motion.a
                ...
                className="group relative flex items-center justify-between p-6 sm:p-8 rounded-2xl bg-[#0f1720]/30 border border-[#354f52]/20 hover:border-[#84a98c]/50 hover:bg-[#0f1720]/50 transition-all duration-500 overflow-hidden font-sans"
              >
                {/* Custom inner glow */}
                <div 
